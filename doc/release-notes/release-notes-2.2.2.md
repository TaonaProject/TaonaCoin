Taona Core version *2.2.2* is now available!!
==============

  <https://github.com/TaonaProject/Taonacoin/releases/tag/v2.2.2>
...
- Enhancements for Taonacoin Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/TaonaProject/Taonacoin/commits/release_2.2.2>

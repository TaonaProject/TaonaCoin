...
This document provides guidelines for internationalization of the Taona Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `taona_en.ts` remains unchanged.

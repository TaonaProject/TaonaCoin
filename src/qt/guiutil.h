...
#ifndef TAONA_QT_GUIUTIL_H
#define TAONA_QT_GUIUTIL_H
...
/** Utility functions used by the Taona Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "taona:" URI into recipient object, return true on successful parsing

...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(TaonaUnits::TNA),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(TaonaUnits::formatWithUnit(unit, balance, false, TaonaUnits::separatorAlways));
    ui->labelUnconfirmed->setText(TaonaUnits::formatWithUnit(unit, unconfirmedBalance, false, TaonaUnits::separatorAlways));
    ui->labelImmature->setText(TaonaUnits::formatWithUnit(unit, immatureBalance, false, TaonaUnits::separatorAlways));
    ui->labelTotal->setText(TaonaUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, TaonaUnits::separatorAlways));
    ui->labelWatchAvailable->setText(TaonaUnits::formatWithUnit(unit, watchOnlyBalance, false, TaonaUnits::separatorAlways));
    ui->labelWatchPending->setText(TaonaUnits::formatWithUnit(unit, watchUnconfBalance, false, TaonaUnits::separatorAlways));
    ui->labelWatchImmature->setText(TaonaUnits::formatWithUnit(unit, watchImmatureBalance, false, TaonaUnits::separatorAlways));
    ui->labelWatchTotal->setText(TaonaUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, TaonaUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("TNA")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the TNA balance grid from expanding and looking terrible when asset balance is hidden

...
#include "config/taona-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatTaonaURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + TaonaUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatTaonaURI(info));
}

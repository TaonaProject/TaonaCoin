...
#ifndef TAONA_QT_TAONAGUI_H
#define TAONA_QT_TAONAGUI_H
...
/**
  Taona GUI main class. This class represents the main window of the Taona UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TaonaGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TaonaGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~TaonaGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a taona wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */

...
#ifndef TAONA_QT_TAONAUNITS_H
#define TAONA_QT_TAONAUNITS_H
...
/** Taona unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TaonaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TaonaUnits(QObject *parent);

    /** Taona units.
      @note Source: https://en.taona.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TNA,
...
typedef TaonaUnits::Unit TaonaUnit;

#endif // TAONA_QT_TAONAUNITS_H

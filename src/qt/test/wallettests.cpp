...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<TaonaAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_taona-qt -platform xcb      # Linux
//     src/qt/test/test_taona-qt -platform windows  # Windows
//     src/qt/test/test_taona-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = TaonaUnits::formatWithUnit(unit, balance, false, TaonaUnits::separatorAlways);
    ...
    // Amount input
    TaonaAmountField* amountInput = receiveCoinsDialog.findChild<TaonaAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: taona:")) != -1);

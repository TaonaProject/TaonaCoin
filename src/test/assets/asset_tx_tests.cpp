...
BOOST_FIXTURE_TEST_SUITE(asset_tx_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_not_valid_test)
    {
        ...
        // This should fail because 900 TAONA doesn't have a destination
        CAssetTransfer assetTransfer("TAONA", 100);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_valid_multiple_outs_test)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            CAssetTransfer asset2("TAONA", 100);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_multiple_assets_test)
    {
        ...
        CAssetTransfer asset2("TAONATEST", 1000);
        CScript scriptPubKey2 = GetScriptForDestination(DecodeDestination(Params().GlobalBurnAddress()));
        asset2.ConstructTransaction(scriptPubKey2);

        CAssetTransfer asset3("TAONATESTTEST", 1000);
        ...
        {
            // Add the first asset
            CAssetTransfer outAsset("TAONA", 100);
            ...
            CAssetTransfer outAsset2("TAONATEST", 100);
            ...
            // Add the third asset
            CAssetTransfer outAsset3("TAONATESTTEST", 100);
        ...
        // The inputs are spending 3000 Assets (1000 of each TAONA, TAONATEST, TAONATESTTEST)
        // The outputs are spending 100 Assets to 10 destinations (10 * 100 = 1000) (of each TAONA, TAONATEST, TAONATESTTEST)

...
#ifndef TAONA_TEST_SCRIPTNUM10_H
#define TAONA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Taona Core 0.10.0, for cross-comparison.
 */
public:

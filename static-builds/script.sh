...
find ${DISTNAME}/bin -type f -executable -exec ../taonacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../taonacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/taonacoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/taonacoin/depends/SDKs/MacOSX10.11.sdk.tar.gz

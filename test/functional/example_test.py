...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TaonaTestFramework
    pass

class ExampleTest(TaonaTestFramework):
    # Each functional test is a subclass of the TaonaTestFramework class.
    ...
    def custom_method(self):
        ...
        TaonaTestFramework class so other tests can use it."""

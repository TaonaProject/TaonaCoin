...
class AssetTest(TaonaTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating TNA for node[0] and activating assets...")
    ...
    def big_test(self):
        ...
        n0.issue("TAONA1", 1000)
        n0.issue("TAONA2", 1000)
        n0.issue("TAONA3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="TAONA*", verbose=False, count=2, start=-2)
        ...
        taona_assets = n0.listassets(asset="TAONA*", verbose=False, count=2, start=-2)
        assert_equal(len(taona_assets), 2)
        assert_equal(taona_assets[0], "TAONA2")
        assert_equal(taona_assets[1], "TAONA3")
        self.sync_all()

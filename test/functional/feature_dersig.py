...
class BIP66Test(TaonaTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # taonad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and taonad produces more specific reject
            # reasons.

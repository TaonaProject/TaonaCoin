...
from test_framework.test_framework import TaonaTestFramework, SkipTest
...
class ZMQTest (TaonaTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that taona has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("taonad has not been built with zmq enabled.")

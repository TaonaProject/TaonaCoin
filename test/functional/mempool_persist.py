...
By default, taonad will dump mempool on shutdown and
...
class MempoolPersistTest(TaonaTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give taonad a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent taonad from writing mempool.dat to disk. Verify that `savemempool` fails")

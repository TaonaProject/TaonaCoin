...
from test_framework.test_framework import TaonaTestFramework
from test_framework.util import *
from test_framework.blocktools import create_block, create_coinbase, add_witness_commitment
from test_framework.script import CScript, OP_TRUE

# TestNode: A peer we use to send messages to taonad, and store responses.
...
class CompactBlocksTest(TaonaTestFramework):
    ...
    # This test actually causes taonad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that taonad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for taonad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # taonad will not send blocktxn responses for blocks whose height is

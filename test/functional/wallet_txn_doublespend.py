...
class TxnMallTest(TaonaTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 TNA:
        ...
        # First: use raw transaction API to send 1240 TNA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 TNA coin each
        ...
        # Node0's balance should be starting balance, plus 50TNA for another
        ...
        # Node0's total balance should be starting balance, plus 100TNA for 
